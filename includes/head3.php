     ...
     <button class="subnavbtn">Features<i class="fa fa-caret-down"></i></button>
       <div class="subnav-content">
        <div class="subnav-trapezoid">
          <a href="newshome.php">free analysis</a>
          <a href="appointment.php">consultation</a>
		  <a href="dashboard.php">expense tracker</a>
         </div>
       </div>
      </div>
    <a href="free.php" class="expandHome">LOGOUT</a>
  </div>
</nav>
